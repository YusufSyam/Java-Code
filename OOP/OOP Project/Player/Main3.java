...
class Main3{
	...
	ArrayList <Player> daftarPlayer= new ArrayList<>();
	...
	static String mainMenu(Player p1) {
		...
		System.out.println("| 10. Berpetualang keluar kota             |"); 
		System.out.println("|_11._Log_Out______________________________|");
		System.out.print(">> ");
	...
	static void adventure(Player player1) {
		while(true) {
			...
			int a= random.nextInt(85+(4*player1.getLevel()));
			...
			if(a<=10) {
				...
				player1.fightMonsters(player1.getMonster(8), 8,player1);
			}else if(a<=190) {
				player1.fightMonsters(player1.getMonster(10), 10, player1);
			}else{
				player1.fightMonsters(player1.getMonster(9), 9, player1);
			}
